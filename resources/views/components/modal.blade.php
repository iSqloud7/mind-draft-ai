...
<div x-data="{ show: @js($show) }"
    ...
    <div x-show="show" class="bg-zinc-950 border border-zinc-900 text-white rounded-2xl overflow-hidden shadow-2xl transform transition-all sm:w-full {{ $maxWidth }}"
